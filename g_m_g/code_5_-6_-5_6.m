...
legend('Equilibrium Point', 'Worst for Evader', 'Best for Ambusher', 'Moderate for both', 'Moderate but better for Evader', 'Moderate but better for Ambusher', 'Location', 'EastOutside')
plot(1-q1,p1,'hb');